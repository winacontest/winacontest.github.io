    ...
    $username   = "";
      ...
      $firstname = $_POST['firstname']; 	//required field
       ...
       if( $valid == true) {
				...
				$to = 'wincontest@rogers.com';
				$subject = 'Trial Offer Request';
				//create a boundary string.  
	  			$random_hash = md5(date('r', time())); 
	  			
	  			$headers = 'From: webmaster@winacontest.com' . "\r\n" .
	  						  'Return-Path: Sylvia Gold <sylviagold@aquaduct.iaw.on.ca>' . "\r\n" . 
    						  'Reply-To: Sylvia Gold <sylviagold@aquaduct.iaw.on.ca>' . "\r\n" .
...
<div id="container">
	...
	<div id="content">
		<!-- #BeginEditable "content" -->
				...
				<h2>Trial Offer - Request Form</h2>
